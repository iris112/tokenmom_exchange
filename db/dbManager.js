...
exports.create_order_detail = create_order_detail;
...
exports.find_create_order = find_create_order;
...
exports.find_order_detail = find_order_detail;
...
exports.find_matching_orders = find_matching_orders;
...
exports.find_orders = find_orders;
...
exports.update_status_order = update_status_order;
...
exports.count_orders = count_orders;
...
exports.create_pending_trades = create_pending_trades;
...
exports.create_trade_histories = create_trade_histories;
function find_trade_histories(base_token, token_symbol, wallet_address, created_at, create_at_after, offset, limit) {
    ...
    if (wallet_address != null) {
        where = Object.assign({}, where, { [Sequelize.Op.or]: [
                {
...
exports.find_trade_histories = find_trade_histories;
...
exports.find_latest_trade_history = find_latest_trade_history;
...
exports.find_reward = find_reward;
...
exports.create_reward_manager = create_reward_manager;
...
exports.find_user_by_wallet = find_user_by_wallet;
...
exports.find_user_by_referral = find_user_by_referral;
...
exports.create_referral_manager = create_referral_manager;
...
exports.find_tokens = find_tokens;
...
exports.create_building_order = create_building_order;
...
exports.delete_building_order = delete_building_order;
...
exports.find_building_order = find_building_order;
