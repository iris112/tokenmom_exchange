...
function parse_market_id(market_id) {
...
exports.parse_market_id = parse_market_id;
...
function get_market_last_price(base_token, token_symbol) {
    return __awaiter(this, void 0, void 0, function* () {
        var trades = yield dbManager.find_trade_histories(base_token, token_symbol, null, null, true, null, null);
        if (trades.length < 1) {
            return "--";
        }
...
function get_market_today_change(base_token, token_symbol) {
    return __awaiter(this, void 0, void 0, function* () {
        var h_price, pre_price, percent;
        var trades = yield dbManager.find_trade_histories(base_token, token_symbol, null, get_now_midnight(), true, null, null);
        if (trades.length < 1) {
            return "--";
        }
        h_price = trades[trades.length - 1].price;
        trades = yield dbManager.find_trade_histories(base_token, token_symbol, null, get_now_midnight(), false, null, null);
        if (trades.length < 1) {
            return 100;
        }
...
function get_market_today_volume(base_token, token_symbol) {
    return __awaiter(this, void 0, void 0, function* () {
        var h_volume = 0;
        var trades = yield dbManager.find_trade_histories(base_token, token_symbol, null, get_now_midnight(), true, null, null);
...
// Private API
router.get('/get_trades', preAction, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var my_trades = yield dbManager.find_trade_histories(base_token, token_symbol, wallet_addr, null, true, (page - global.PAGE_DEFAULT_NUM) * page_size, page_size);
...
// Public API
function get_all_markets_handler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var last_price, today_change, today_volume;
        var json_data = {
            "status": 'success',
        };
        var tokens = yield dbManager.find_tokens();
        if (tokens.length > 0) {
            var market_weth = {
                "base_token": "WETH",
            ...
            for (var i = 0; i < tokens.length; i++) {
                ...
                last_price = yield get_market_last_price("WETH", tokens[i].symbol);
                today_change = yield get_market_today_change("WETH", tokens[i].symbol);
                today_volume = yield get_market_today_volume("WETH", tokens[i].symbol);
                let market = {
            ...
            for (var i = 0; i < tokens.length; i++) {
                ...
                last_price = yield get_market_last_price("TM", tokens[i].symbol);
                today_change = yield get_market_today_change("TM", tokens[i].symbol);
                today_volume = yield get_market_today_volume("TM", tokens[i].symbol);
                let market = {
            ...
            for (var i = 0; i < tokens.length; i++) {
                ...
                last_price = yield get_market_last_price("USDC", tokens[i].symbol);
                today_change = yield get_market_today_change("USDC", tokens[i].symbol);
                today_volume = yield get_market_today_volume("USDC", tokens[i].symbol);
                let market = {
            ...
            for (var i = 0; i < tokens.length; i++) {
                ...
                last_price = yield get_market_last_price("WBTC", tokens[i].symbol);
                today_change = yield get_market_today_change("WBTC", tokens[i].symbol);
                today_volume = yield get_market_today_volume("WBTC", tokens[i].symbol);
                let market = {
...
router.get('/get_markets', preAction, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var market_id = req.query.market_id;
        var base_token, token_symbol, market;
        ...
        var token = yield dbManager.find_token(token_symbol);
        if (token == undefined) {
        ...
        last_price = yield get_market_last_price(base_token, token_symbol);
        today_change = yield get_market_today_change(base_token, token_symbol);
        today_volume = yield get_market_today_volume(base_token, token_symbol);
        let market_data = {
            market_id,
            base_token,
            base_token_decimals,
...
function get_market_ticker(base_token, token_symbol) {
    return __awaiter(this, void 0, void 0, function* () {
        var ticker = {
        ...
        var last_trade = yield dbManager.find_latest_trade_history(base_token, token_symbol);
        if (last_trade == null) {
            return ticker;
        }
        ...
        var trades = yield dbManager.find_trade_histories(base_token, token_symbol, null, from, true, null, null);
        for (var i = 0; i < trades.length; i++) {
...
function get_all_tickers_handler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var last_price, today_change, today_volume;
        var json_data = {
            "status": 'success',
        ...
        if (tokens.length > 0) {
            for (var i = 0; i < tokens.length; i++) {
                ...
                ticker = yield get_market_ticker("WETH", tokens[i].symbol);
                tickers.push(ticker);
            }
            for (var i = 0; i < tokens.length; i++) {
                if (tokens[i].tm_field != 1) {
                ...
                ticker = yield get_market_ticker("TM", tokens[i].symbol);
                tickers.push(ticker);
            }
            for (var i = 0; i < tokens.length; i++) {
                if (tokens[i].usdc_field != 1) {
                ...
                ticker = yield get_market_ticker("USDC", tokens[i].symbol);
                tickers.push(ticker);
            }
            for (var i = 0; i < tokens.length; i++) {
                if (tokens[i].symbol == "WBTC") {
                ...
                ticker = yield get_market_ticker("WBTC", tokens[i].symbol);
                tickers.push(ticker);
            }
...
router.get('/get_tickers', preAction, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var market_id = req.query.market_id;
        var base_token, token_symbol, market;
        var json_data = {
        ...
        var ticker = yield get_market_ticker(base_token, token_symbol);
